# -*- coding: utf-8 -*-
"""
Created on Thu May  6 16:09:58 2021
...
def n(x):
    #the real function to estimate ofc bitch 
...
for i in range(0, n_obs):
    ...
    gp = GaussianProcessRegressor(kernel = kernel, alpha = noise_std**2, normalize_y = 1, n_restarts_optimizer = 10)
